/*
Определите обобщенную функцию чтения архива, способную читать ZIP-файлы
(archive/zip) и POSIX tar-файлы (archive/tar). Воспользуйтесь механизмом
регистрации, аналогичным описанному выше, чтобы поддержка каждого формата файла
